    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <span className="text-sm font-bold text-white tracking-wide">{getPresetDisplayName(preset, language)}</span>
          <span className="text-[10px] text-purple-300 font-semibold">{preset.author || 'TtMix'}</span>
        </div>
              ...
              <div>
                ...
                <p className="text-xs text-zinc-300">
                  ...
                  <span className="font-bold text-rose-300">
                    &quot;{getPresetDisplayName(deleteConfirmTarget, language)}&quot;
                  </span>
                </p>
              </div>
